...
class Solution:
    def kClosest(self, points: List[List[int]], k: int) -> List[List[int]]:
        self._quicksort(points, 0, len(points) - 1)
        return points[:k]

    def _quicksort(self, points: List[List[int]], start_idx: int, end_idx: int) -> None:
        ...
        self._quicksort(points, start_idx, write_idx - 1)
        self._quicksort(points, write_idx + 1, end_idx)
